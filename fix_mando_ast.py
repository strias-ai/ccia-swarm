...
def repair_file(filepath):
    print(f"🛠️ Reparación inteligente AST en {filepath}...")
    ...
    # Retroceder línea por línea hasta que el bloque superior sea sintácticamente válido por sí solo
    valid_head = ""
    for i in range(cut_idx, 0, -1):
        candidate_head = "".join(lines[:i])
        try:
            ast.parse(candidate_head)
            valid_head = candidate_head
            break
        except SyntaxError:
            continue
...
repair_file("/home/k1/ccia_workspace/ccia_mando_63.py")
repair_file("/home/k1/ccia_workspace/modules/art_63.py")
