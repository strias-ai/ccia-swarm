...
print("=" * 80)
print("🧬 INSTALANDO ARTEFACTO 64 (VERSIÓN PARCHEADA Y SEGURA)")
print("   - Sandbox Avanzado (Análisis AST y Sintaxis)")
print("   - Telemetría conectada al Mission Control (university.db)")
print("=" * 80)
...
print(f"  ✅ Base de datos local de Genoma verificada en: {db_genome_path}")

# Definición del Módulo Artefacto 64 Refactorizado
...
os.makedirs(os.path.dirname(art64_path), exist_ok=True)
with open(art64_path, "w", encoding="utf-8") as f:
    f.write(art64_code)
print(f"  ✅ Módulo Artefacto 64 inyectado en: {art64_path}")

subprocess.run([sys.executable, "-m", "py_compile", art64_path], check=True)
print("  ✅ Parche completado. Ejecuta el script principal o los módulos para que Artefacto 63 herede estas defensas.")
