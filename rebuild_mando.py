...
def clean_rebuild(filepath):
    ...
    head = []
    for line in lines:
        if line.strip().startswith("def show_mando_menu") or line.strip().startswith("if __name__"):
            break
        head.append(line)

    full_code = "".join(head).rstrip() + "\n\n" + menu_code.strip() + main_block
...
clean_rebuild("/home/k1/ccia_workspace/ccia_mando_63.py")
clean_rebuild("/home/k1/ccia_workspace/modules/art_63.py")
