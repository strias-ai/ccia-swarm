...
def clean_and_repair(filepath):
    print(f"🛠️ Reparando {filepath}...")
    with open(filepath, "r", encoding="utf-8", errors="ignore") as f:
        content = f.read()

    cut_markers = ["def show_mando_menu", "if __name__ =="]
    cut_pos = len(content)
...
clean_and_repair("/home/k1/ccia_workspace/modules/art_63.py")
clean_and_repair("/home/k1/ccia_workspace/ccia_mando_63.py")
